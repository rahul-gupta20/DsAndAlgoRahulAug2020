   ...
   public static class LinkedList{
    ...
    //   }
       ...
       public void kthNode( int k ){
           ...
           System.out.println( ans.data);  // jab aap list k piche se inedx pass krke data lena chahte ho !! example -- 0th index , 1st index , 2nd index piche se data
           
           // System.out.println( ans.next.data ); // jab aap list k piche se value pass krke data lena chahte ho !!  example -- last , second last , 3rd last piche se data 
